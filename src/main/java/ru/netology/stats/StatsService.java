...
public class StatsService {
    ...
    public int calculateMinAverageMonthlySale(int[] sales) { //Месяцы продаж ниже среднего
    ...
    public int calculateMaxAverageMonthlySale(int[] sales) { //Месяцы продаж выше среднего
